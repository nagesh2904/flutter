      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Apeksha Bhardwaj is a Product Designer with over 5 years of experience in creating user-centered designs. '
            ...
            ContactRow(
              icon: Icons.email,
              text: 'apeksha.bhardwaj@email.com',
            ),
            ContactRow(
              icon: Icons.phone,
              text: '(555) 123-4567',
            ...
            ContactRow(
              icon: Icons.link,
              text: 'linkedin.com/in/apekshabhardwaj',
            ),
          ],
        ),
      ),
